	...
	public static class jQueryBy extends By {
		...
		public List<WebElement> findElements(SearchContext context) {
			...
			if (context instanceof FirefoxDriver) {
				// in firefox, complex jQuery result set seems to lockup the browser. so, get
		...
		/**
		 * Method will try to type cast Object into the requested Type of Object, will
		 * throw a runtime exception if the type cast fails.
		 * 
		 * @param context  - instance of the driver
		 * @param selector - the selector to look up by
